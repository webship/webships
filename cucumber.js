module.exports = {
  default: {
    ...
    worldParameters: {
      ...
      // Test users for the roles of the WebAPI Starter site template, the
      // one the suite installs with the Webships installer.
      //
      // Webmaster is the site-install super-admin (created by `drush
      // site:install webships ... --account-name=webmaster
      // --account-pass=dD.123123ddd`). The rest are provisioned by
      // `Given I add testing users` (see
      // tests/step-definitions/webships.steps.js). That step iterates this
